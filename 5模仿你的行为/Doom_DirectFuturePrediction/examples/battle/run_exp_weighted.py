...
def main(main_args):
	...
	print("++++++++")
	print(float(main_args[0]),float(main_args[1]),float(main_args[2]))
	print("++++++++")
	experiment_args = {}
	experiment_args['num_train_iterations'] = 820000
	experiment_args['test_objective_coeffs_temporal'] = np.array([0., 0., 0., 0.5, 0.5, 1.])
	experiment_args['test_objective_coeffs_meas'] = np.array([float(main_args[0]),float(main_args[1]),float(main_args[2])])
